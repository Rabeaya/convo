  ...
  if (chat._user && chat._user.userId) {
    ...
    if (userFromList) {
      ...
      enrichedUser = {
        ...
        firstName: nameParts.length > 0 ? nameParts[0] : chat._user.firstName || chat._user.first_name,
        lastName: nameParts.length > 1 ? nameParts.slice(1).join(' ') : chat._user.lastName || chat._user.last_name,
        first_name: nameParts.length > 0 ? nameParts[0] : chat._user.firstName || chat._user.first_name,
        last_name: nameParts.length > 1 ? nameParts.slice(1).join(' ') : chat._user.lastName || chat._user.last_name,
        email: chat._user.email,
      };
    }
  }
